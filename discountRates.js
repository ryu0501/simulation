...
window.discountRatesData = [
    ...
    { threshold: 150, rate: 10.5 },
    { threshold: 160, rate: 11.2 },
    { threshold: 170, rate: 11.9 },
    { threshold: 180, rate: 12.6 },
    { threshold: 190, rate: 13.3 },
    { threshold: 200, rate: 14.0 },
    { threshold: 210, rate: 14.7 },
    { threshold: 220, rate: 15.4 },
    { threshold: 230, rate: 16.1 },
    { threshold: 240, rate: 16.8 },
    { threshold: 250, rate: 17.5 },
    { threshold: 260, rate: 18.2 },
    { threshold: 270, rate: 18.9 },
